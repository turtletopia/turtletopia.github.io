...
The most basic usage is straightforward. The library's primary function is `ic()`, which takes an argument of any time, prints its value to the screen and returns it invisibly.
